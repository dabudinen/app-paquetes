                    ...
                    <div className="card-body p-4 p-lg-5 text-black">
                      ...
                      <form>
                        ...
                        <div className="form-outline mb-4">
                          ...
                          <label className="form-label" htmlFor="form2Example27">Clave</label>
                        </div>
                        ...
                        <a className="small text-muted" href="#!">Olvidate tu clave?</a>
                        <p className="mb-5 pb-lg-2">No tienes cuenta? <a href="/register">registrate aquí</a></p>
                        <a href="#!" className="small text-muted">Terminos y condiciones.</a>
